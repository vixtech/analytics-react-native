...
exports.configure = function (writeKey, _a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0: return [4 /*yield*/, Promise.all(using.map(function (integration) { return __awaiter(void 0, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                ...
                case 1:
                    ...
                    return [2 /*return*/, __assign(__assign({}, config), { json: json })];
            }
        });
    });
};
